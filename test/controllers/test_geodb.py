...
class TestGeodb(unittest.TestCase):
    ...
    def test_register_user(self, m):
        ...
        with self.assertRaises(api.ApiError) as e:
            geodb.register_user(token=mock_token, payload=self._payload)
        ...
        res = geodb.register_user(token='ascd', payload=self._payload)
    ...
    def test_delete_user(self, m):
        ...
        with self.assertRaises(api.ApiError) as e:
            geodb.delete_user(token='ascd', user_id='asdc')
