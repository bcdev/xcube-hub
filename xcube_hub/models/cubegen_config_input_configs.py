...
from xcube_hub.models.cubegen_config_open_params import CubegenConfigOpenParams  # noqa: E501
...
class CubegenConfigInputConfigs(Model):
    ...
    def __init__(self, store_id=None, data_id=None, open_params=None):  # noqa: E501
        """CubegenConfigInputConfigs - a model defined in OpenAPI
    ...
    @open_params.setter
    def open_params(self, open_params):
